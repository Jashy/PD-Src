...
## Report the derate settings
#echo "$mode $pvt_wire derate settings" >  ${SESSION}.run/derate_settings.rpt
#report_timing_derate -nosplit          >> ${SESSION}.run/derate_settings.rpt
set_false_path   -from [get_clocks RTHCLK]  -to [get_clocks RTHCLK]
set_false_path   -from [get_clocks ctmd_RTHCLK]  -to [get_clocks ctmd_RTHCLK]
