proc split_clock_center_tall {args } {
...
###tall center
 ...
 set ymax 0
	...
	foreach_in_collection p [get_pins $pin_list] {
...
set center_location [list [expr ($xmax + $xmin)/2 ] [expr ($ymax +$ymin)/2]]


#	set pin_location "$x $y" 
	move_objects -to  "$center_location"  [get_cells [list  $new_cell_name]]
################	
