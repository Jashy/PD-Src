...
proc insert_dummy_gating {root_pin_names} {
  ...
  set regular_flipflop_pattern "*DF*"
  set scan_flipflop_pattern    "*DF*"

  set gating_model_name            [ get_model CKLNQDD8 ]
  set gating_model_out_pin_name    "Q"
  set gating_model_clock_pin_name  "CP"
  set gating_model_enable_pin_name "" ; # "E"
  set gating_model_test_pin_name   "" ; # "TE"

  set tie_hi_model_name            "" ; #  [ get_model TIEH ]
  set tie_lo_model_name            "" ; # [ get_model TIEL ]
  set tie_hi_model_out_pin_name    "" ; # "Z"
  set tie_lo_model_out_pin_name    "" ; # "ZN"
  ...
  foreach root_pin_name $root_pin_names {
	...
	if {$gating_model_enable_pin_name != ""} {
        	if { $tie_hi_model_name != "" } {
