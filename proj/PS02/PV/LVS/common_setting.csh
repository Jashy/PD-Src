...
set icc_netlist     = "../release/${TOP}_icc.v"
set icc_pg_netlist  = "../release/${TOP}_icc_pg.v"
set lvs_netlist     = "../release/${TOP}_lvs.v"
set lvs_pg_netlist  = "../release/${TOP}_lvs_pg.v"
set lvs_spice       = "../release/${TOP}_lvs.spi"
set lvs_pg_spice    = "../release/${TOP}_lvs_pg.spi"
set gds_ready       = "../release/gds_ready"
set vnet_ready      = "../release/vnet_ready"
set vnet_pg_ready   = "../release/vnet_pg_ready"

################# Design Rule ########################################
set calibre_lvs_rule  = "/proj/PS02/RELEASE/PV/PV_RULE_rev05/RULE/LVS/ln28lpp.lvs.cal"
set calibre_drc_rule  = "/proj/PS02/RELEASE/PV/PV_RULE_rev05/RULE/DRC/cmos28lp.drc.cal"
set calibre_lvs_hcell = "/proj/PS02/RELEASE/PV/PV_RULE_rev05/HCELL_0202"
